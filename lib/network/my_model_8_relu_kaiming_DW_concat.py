...
def get_model(out_channel):
    ...
    models['block1_7'] = make_layer(BasicBlock, 224, 64, 1)  # 要将96channel的concat过来 96+128->64
    models['block1_8'] = make_layer(BasicBlock_sig, 192, out_channel, 1)  # 要将128channel的concat过来 64+128->18
